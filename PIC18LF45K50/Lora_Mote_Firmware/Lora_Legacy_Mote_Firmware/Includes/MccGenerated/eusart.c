...
/**
  Section: EUSART APIs
*/
//#define WORK_CLOCK_FREQ 48000000
//#define GetSystemClock() WORK_CLOCK_FREQ
...
void EUSART_Initialize(void)
{
    ...
    SPBRG = 0xD0;   // Baud Rate = 57600; SPBRGL 68; 
//    SPBRG = 0x71; // Baud Rate = 19200; SPBRGL 68; 
    

    // Baud Rate = 57600; SPBRGH 0; 
    SPBRGH = 0x00;      // Baud Rate = 57600; SPBRGL 68; 
//    SPBRGH = 0x02;    // Baud Rate = 19200; SPBRGL 68; 
...
void EUSART_FlushBuffer(void)
{
    uint8_t index;
    for (index=0; index < 64; index++)
    {
        eusartRxBuffer[index] = 0;
    }
    eusartRxHead = 0;
    eusartRxTail = 0;
    eusartRxCount = 0;
