...
# Source Files
SOURCEFILES=main.c ../Includes/Board/poweruptest.c ../Includes/Board/MOTEapp.c ../Includes/Board/USBapp.c ../Includes/Drivers/buttons.c ../Includes/Drivers/TMRapp.c ../Includes/Drivers/SSD1306oLED.c ../Includes/MccGenerated/eusart.c ../Includes/MccGenerated/interrupt_manager.c ../Includes/MccGenerated/mcc.c ../Includes/MccGenerated/adc.c ../Includes/MccGenerated/spi.c ../Includes/MccGenerated/tmr1.c ../Includes/MccGenerated/pin_manager.c ../Includes/MccGenerated/memory.c ../Includes/MccGenerated/cmp1.c ../Includes/MccGenerated/fvr.c ../Includes/MccGenerated/tmr2.c ../Includes/Usb/Framework/usb_device.c ../Includes/Usb/Framework/usb_device_cdc.c ../Includes/Usb/usb_descriptors.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote.X.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=icd3  -DXPRJ_Standalone=$(CND_CONF)  --double=32 --float=32 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -P -N255 -I"../Includes/MccGenerated" -I"../Includes/Drivers" -I"../Includes/Board" -I"../Includes/Usb" -I"../Includes/Usb/Framework" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote.X.${IMAGE_TYPE}.map  -DXPRJ_Standalone=$(CND_CONF)  --double=32 --float=32 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -P -N255 -I"../Includes/MccGenerated" -I"../Includes/Drivers" -I"../Includes/Board" -I"../Includes/Usb" -I"../Includes/Usb/Framework" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
