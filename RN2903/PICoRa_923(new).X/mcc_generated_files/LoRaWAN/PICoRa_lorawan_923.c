...
static const ChannelParams_t DefaultChannels923 [MAX_US_CHANNELS] =   {  LC0_923,  LC1_923,  LC2_923,  LC3_923,  LC4_923,  LC5_923,
                                                                         LC6_923,  LC7_923,  LC8_923,  LC9_923,  LC10_923, LC11_923,
                                                                         LC12_923, LC13_923, LC14_923, LC15_923, LC16_923};
/*                                                                       LC17_923,LC18_923, LC19_923, LC20_923, LC21_923, LC22_923, LC23_923,
                                                                         LC24_923, LC25_923, LC26_923, LC27_923, LC28_923, LC29_923,
                                                                         LC30_923, LC31_923, LC32_923, LC33_923, LC34_923, LC35_923,
                                                                         LC36_923, LC37_923, LC38_923, LC39_923, LC40_923, LC41_923,
                                                                         LC42_923, LC43_923, LC44_923, LC45_923, LC46_923, LC47_923,
                                                                         LC48_923, LC49_923, LC50_923, LC51_923, LC52_923, LC53_923,
                                                                         LC54_923, LC55_923, LC56_923, LC57_923, LC58_923, LC59_923,
                                                                         LC60_923, LC61_923, LC62_923, LC63_923, LC64_923, LC65_923,
                                                                         LC66_923, LC67_923, LC68_923, LC69_923, LC70_923, LC71_923 */
...
void LORAWAN_Init(RxAppDataCb_t RxPayload, RxJoinResponseCb_t RxJoinResponse) // this function resets everything to the default values
{
    ...
    RADIO_Init(&radioBuffer[16], AS923_CALIBRATION_FREQ);
 ...
 void LORAWAN_Reset (void)
{
    ...
    loRa.receiveWindow2Parameters.frequency = AS923_DEFAULT_RX_WINDOW2_FREQ;
    loRa.receiveWindow2Parameters.dataRate = AS923_DEFAULT_RX_WINDOW2_DR;   
...
static void InitDefault923Channels (void)
{
    ...
    memcpy (Channels, DefaultChannels923, sizeof(DefaultChannels923) );
...
// Generates a frequency for US upstream, utilizing LoRa 125 kHz BW varying from SF7 to SF10 (DR0..DR3) starting at 921.6 MHz and incrementing linearly by 200 kHz to 923.4 MHz
static uint32_t GenerateUSFrequency1 (uint8_t channelIndex)   // channelIndex should be a random number between 0 and 16, generated with the random function
{
    uint32_t channelFrequency;

    channelFrequency = AS923_UPSTREAM_CH0 + FREQ_200KHZ * channelIndex;
    return channelFrequency;
}

// Generates a frequency for US upstream, utilizing LoRa 500 kHz BW at SF8 (DR4) starting at 921.6 MHz and incrementing linearly by 1.6 MHz to 923.4 MHz
static uint32_t GenerateUSFrequency2 (uint8_t channelIndex)
{
    uint32_t channelFrequency;

    channelFrequency = AS923_UPSTREAM_CH16 + FREQ_1600KHZ * (channelIndex - MAX_US_CHANNELS_BANDWIDTH_125);
    return channelFrequency;
}
...
static uint32_t GenerateUSFrequencyReception (uint8_t channelIndex)
{
    ...
    channelFrequency = AS923_DOWNSTREAM_CH0 + FREQ_600KHZ * channelIndex;
    return channelFrequency;
}
