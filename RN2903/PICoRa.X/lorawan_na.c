...
static const ChannelParams_t DefaultChannels915 [MAX_US_CHANNELS] =   {  LC0_923,  LC1_923,  LC2_923,  LC3_923,  LC4_923,  LC5_923,
...
static uint32_t GenerateUSFrequency2 (uint8_t channelIndex)
{
    ...
    channelFrequency = AS923_UPSTREAM_CH64 + FREQ_1600KHZ * (channelIndex - MAX_US_CHANNELS_BANDWIDTH_125);
    return channelFrequency;
}
